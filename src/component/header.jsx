        ...
        <div className="wrapper">
          <div className="region region-header">
            <div className="region-inner clearfix">
              <div
                id="block-block-4 mb-0"
                className="block block-block no-title"
              >
                <div className="block-inner clearfix">
                  <div className="block-content content">
                    <div className="tophead_left">
                      <span className="flex">
                        {topHeader &&
                          topHeader?.pages?.edges[0]?.node?.homePage?.topHeaderLeftMenu.map(
                            (item, index) => {
                              return (
                                <a
                                  key={"left" + index}
                    ...
                    <div className="tophead_right">
                      {topHeader &&
                        topHeader?.pages?.edges[0]?.node?.homePage?.topHeaderRightMenu?.map(
                          (item, index) => {
                            return (
                              <a
                                key={"right" + index}
                                href={item?.menuLink?.url}
                                className="loginlinks skip-link"
                              >
                                {item?.menuTitle}
                              </a>
                            );
          ...
          <div className="flex py-2">
            ...
            <div id="logo">
              ...
              >
                <img
                  alt="Logo"
                  src={
                    logo?.pages?.edges[0]?.node?.homePage?.logo?.mediaItemUrl
                  }
                  typeof="foaf:Image"
                  className="site-logo"
                />
            ...
            {floatElements && (
              <div className="float-element">
                {floatElements?.pages?.edges[0]?.node?.homePage?.floatElement?.map(
                  (item, index) => {
                    return (
                      <a
                        key={"floatElement" + index}
                        href={item?.floatElementUrl?.url}
                        target="_blank"
                        className="g20"
                        rel="noopener noreferrer"
                      >
                        <img
                          ...
                          src={item?.floatImage?.mediaItemUrl}
                          alt="G20"
                          style={{ height: "73px" }}
                        />
                      </a>
            ...
            <button
              className={showMenu ? "toggle-bar cross" : "toggle-bar"}
              onClick={toggleMenu}
            ></button>
      ...
      <section className={showMenu ? "bottom_header active" : "bottom_header"}>
        <div className="wrapper">
          <ul className="menus">
            ...
            <li>
              <Link href={"#"}>
                Dashboard <span className="indicator">+</span>
              </Link>
              <ul className="submenu">
                ...
                <li>
                  <Link href={"#"}>PMKVY</Link>
                </li>
              </ul>
            </li>
            <li>
              <Link href={"#"}>
                About MSDE <span className="indicator">+</span>
              </Link>
              <ul className="submenu">
                <li>
                  <Link href={"#"}>About MSDE</Link>
                </li>
                <li>
                  <Link href={"#"}>Background</Link>
                </li>
                <li>
                  <Link href={"#"}>Allocation of Business Rules</Link>
                </li>
                <li>
                  <Link href={"#"}>Acts & Rules</Link>
                </li>
                <li>
                  <Link href={"#"}>Citizen Charter</Link>
                </li>
                <li>
                  <Link href={"#"}>Organizations Structure</Link>
                </li>
                <li>
            ...
            <li>
              <Link href={"#"}>
                Organizations <span className="indicator">+</span>
              </Link>
              <ul className="submenu">
                <li>
                  <Link href={"#"}>Directorate General of Training(DGT)</Link>
                </li>
                <li>
                  <Link href={"#"}>
                    Directorate of Jan Skhikshan Sansthan(DJSS)
                  </Link>
                </li>
                <li>
                  <Link href={"#"}>
                    National Council for Vocational Education and Training(NSDC)
                  </Link>
                </li>
              </ul>
            </li>
            <li>
              <Link href={"#"}>
                Schemes & Initiatives <span className="indicator">+</span>
              </Link>
            </li>
            <li>
              <Link href={"#"}>
                Report/Documents <span className="indicator">+</span>
              </Link>
            </li>
          </ul>
        </div>
